...
if(isset($_POST['deactivate'])) {
    ...
    $user = new User();
    $user->updateStatus($userId, 2);
    $session::set('msg1', 'User deactivated successfully!');
...
if(isset($_POST['activate'])) {
    ...
    $session::set('msg1', 'User activated successfully!');
    echo "<script>window.location.href='manage-admin.php';</script>";
    exit;
}

$user = new User();
$userList = $user->getDistinctUsersByStatus([1,2], "admin");
                    ...
                    <div class="container-fluid px-4">
                        <div class="card__wrapper">
                            <div class="card__title-wrap mt-4 mb-20">
                                <h3 class="table__heading-title">Manage Admin</h3>
                            </div>
                                ...
                                ?>
                                        <div class="accordion-item faq-item"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-2 d-flex align-items-center">
                                                    <p><?php echo $status == 1 ? 'Active' : 'Deactive'; ?></p>
                                                </div>
                                                <div class="col-lg-3 d-flex align-items-center">
                                                    <form action="" method="post">
                                                        <input type="hidden" name="user_id" value="<?php echo $userId; ?>">
                                                        <?php if ($status == 1) { ?>
                                                            <button type="submit" name="deactivate" class="btn btn-danger" value="<?php echo $userId; ?>">Deactivate</button>
                                                        <?php } else { ?>
                                                            <button type="submit" name="activate" class="btn btn-success" value="<?php echo $userId; ?>">Activate</button>
                                                        <?php } ?>
                                                    </form>
                                                </div>
                                            </div>
