                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            ...
                            <form method="post">
                                ...
                                <!-- Seat Quota (per‑department accordion) -->
<div class="text-center my-4">
  <h5 class="form-info-title">Seat Quota by Department</h5>
</div>

<div class="accordion" id="departmentQuotaAccordion">
  <?php foreach ($departmentList as $dept): ?>
    <div class="accordion-item">
      ...
      <div id="collapseDept<?php echo $dept['department_id']; ?>" 
           ...
           data-bs-parent="#departmentQuotaAccordion">
        <div class="accordion-body">
          <div class="row">
            <?php 
            // reuse your existing $labels array for semester names
            foreach ($labels as $field => $label): 
              // name="quota[deptId][field]" so you can process $_POST['quota'][$deptId][$field] later
            ?>
              <div class="col-md-6 mb-3">
                <label class="form-label" for="quota_<?php echo $dept['department_id'].'_'.$field; ?>">
                  <?php echo $label; ?>
                </label>
                <input type="number"
                       class="form-control"
                       ...
                       value="<?php 
                         // if in edit mode you might populate it from a two‑dim array: 
                         echo htmlspecialchars($quotaValuesByDept[$dept['department_id']][$field] ?? '');
                       ?>"
                       required>
              </div>
            <?php endforeach; ?>
