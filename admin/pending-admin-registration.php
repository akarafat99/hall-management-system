...
if (isset($_POST['approve']) || isset($_POST['decline'])) {
    ...
    if ($status == 1) {
        showPopup("User ID " . $user_id . " approved successfully.");
    } else {
        showPopup("User ID " . $user_id . " declined successfully.");
    }
}

$user = new User();
$userList = $user->getDistinctUsersByStatus(0, "admin"); // Get all pending users
                    ...
                    <div class="container-fluid px-4">
                        <div class="card__wrapper">
                            <div class="card__title-wrap mt-4 mb-20">
                                <h3 class="table__heading-title">Review Admin Account Registration</h3>
                            </div>
